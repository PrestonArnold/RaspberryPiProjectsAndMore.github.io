...
- Official remote control app is not working (gapps issue?)
...
1. Download [open_gapps-arm-10.0-tvstock-xxxxxxxx.zip](https://opengapps.org/?arch=arm&api=10.0&variant=tvstock) and save it to your device's internal storage or use an external USB drive (20200714 is the latest available at the moment)
